...
/**
 * This DataFlex Web Service opens up country information. 2 letter ISO codes are used for Country code.
 * There are functions to retrieve the used Currency, Language, Capital City, Continent and Telephone code.
 *
 * This class was generated by Apache CXF 3.3.4
 * 2022-10-20T00:48:30.506+04:00
 * Generated source version: 3.3.4
 *
 */
@WebServiceClient(name = "CountryInfoService",
                  wsdlLocation = "classpath:wsdl/countryinfoservice.wsdl",
...
public class CountryInfoService extends Service {
    ...
    static {
        URL url = CountryInfoService.class.getClassLoader().getResource("wsdl/countryinfoservice.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(CountryInfoService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "classpath:wsdl/countryinfoservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
